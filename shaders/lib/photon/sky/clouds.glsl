...
#ifndef PHOTON_SKY_CLOUDS_INCLUDE_GUARD
#define PHOTON_SKY_CLOUDS_INCLUDE_GUARD

#include "/lib/photon/sky/clouds/altocumulus.glsl"
#include "/lib/photon/sky/clouds/cirrus.glsl"
#include "/lib/photon/sky/clouds/cumulus.glsl"
#include "/lib/photon/sky/clouds/cumulus_congestus.glsl"
#include "/lib/photon/sky/clouds/noctilucent.glsl"
...
CloudsResult draw_clouds(
    ...
    vec4 result_nlc
        = draw_noctilucent_clouds(air_viewer_pos, ray_dir, clear_sky, distance_to_terrain);
...
#endif // PHOTON_SKY_CLOUDS_INCLUDE_GUARD
