...
#ifndef PHOTON_UTILITY_FAST_MATH_INCLUDE_GUARD
#define PHOTON_UTILITY_FAST_MATH_INCLUDE_GUARD
...
float photon_pow5(float x) { return pow4(x) * x; }
...
#endif // PHOTON_UTILITY_FAST_MATH_INCLUDE_GUARD
